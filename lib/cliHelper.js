...
function printHelp(argv) {
    ...
    console.log("\nOptions:");
    console.log("  --in (-i)            - Data directory from which to read labeled data");
    console.log("  --ratio (-r)         - Ratio of labeled data to learn on");
    console.log("  --num (-n)           - Number of times to iterate the evaluation (each with different train/test partitioning)");
    console.log("\nFlags:");
    console.log("  --help (-h)          - Print usage");
    console.log("  --quiet (-q)         - Don't print the results of each iteration. Useful for large `n`");
    console.log("\n\nYour args: ", argv);
}
